...
<p style="width: 90.2%;
    margin-left: 20%;
    border-top: 0;">
    	<form style="margin:0 auto;width:20%;text-align:left" action="delete_your_book1.php" method="post">
  <b style="color: black;">Enter name of the book to be deleted from your library</b>
